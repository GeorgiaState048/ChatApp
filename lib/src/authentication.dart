...
class Authentication extends StatelessWidget {
  ...
  Widget theSignOut(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    switch (loginState) {
      ...
      case ApplicationLoginState.newerEmail:
        return EmailForm(
            ...
            Padding(
              ...
              child: StyledButton(
                onPressed: () {
                  showDialog(
                    context: context,
                    builder: (BuildContext context) => theSignOut(context),
                  );
                },
                child: const Text('LOGOUT from ADMIN'),
              ),
            ),
          ],
        );
